...
public class BaseTest {
   static WebDriver driver;
        ...
        static Logger logger = LoggerFactory.getLogger(tests.BaseTest.class);

        SoftAssert softAssert = new SoftAssert(); // выполняет все методы в тесте, даже если какойто из них упал
